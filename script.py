...
def main():
    ...
    st.session_state.code_prompt = st.text_area(
        ...
        help="Type the instructions for the AI to generate code",
    ...
    with st.expander("Input Options"):
        with st.container():
            st.session_state.code_input = st.text_input("Input (Stdin)", placeholder="e.g., 5 10 (Standard input for execution)", help="Provide standard input for code execution", label_visibility='collapsed',value=st.session_state.code_input)
            st.session_state.code_output = st.text_input("Output (Stdout)", placeholder="Expected output...", help="Expected standard output for reference", label_visibility='collapsed',value=st.session_state.code_output)
    ...
    with st.form('code_controls_form'):
        ...
        with file_name_col:
            code_file = st.text_input("File name", value="", placeholder="main.py", help="Enter a file name to save the generated code", label_visibility='collapsed')
