...
def main():
    ...
    with st.form('code_controls_form'):
        ...
        with generate_code_col:
            ...
            generate_submitted = st.form_submit_button(button_label, help="Generate or complete code using selected AI")
        ...
        with debug_code_col:
            debug_submitted = st.form_submit_button("Debug", help="Debug code based on instructions")
        ...
        with run_code_col:
            execute_submitted = st.form_submit_button("Execute", help="Run the generated code")
