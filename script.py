...
def main():
    ...
    with st.form('code_controls_form'):
        ...
        with debug_code_col:
            debug_submitted = st.form_submit_button("Debug", help="Debug the code based on the provided instructions.")
        ...
        with convert_code_col:
            convert_submitted = st.form_submit_button("Convert", help="Convert the code to another programming language.")
            ai_llm_selected = None
        ...
        with run_code_col:
            execute_submitted = st.form_submit_button("Execute", help="Run the code in the selected compiler.")
