...
def main():
    ...
    with st.form('code_controls_form'):
        ...
        with debug_code_col:
            debug_submitted = st.form_submit_button("Debug", help="Analyze and fix errors in the generated code")
        ...
        with convert_code_col:
            convert_submitted = st.form_submit_button("Convert", help="Convert code to the selected programming language")
            ai_llm_selected = None
        ...
        with example_code_col:
            example_submitted = st.form_submit_button("Example", help="Load a random example task and prompt")
