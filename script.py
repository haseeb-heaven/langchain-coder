...
def main():
    ...
    st.session_state.code_prompt = st.text_area(
        ...
        help="Provide the prompt for code generation or completion.",
    ...
    with st.expander("Input Options"):
        with st.container():
            st.session_state.code_input = st.text_input("Input (Stdin)", placeholder="Input (Stdin)", help="Standard input for the code execution.", label_visibility='collapsed',value=st.session_state.code_input)
            st.session_state.code_output = st.text_input("Output (Stdout)", placeholder="Output (Stdout)", help="Expected standard output for the code execution.", label_visibility='collapsed',value=st.session_state.code_output)
            st.session_state.code_fix_instructions = st.text_input("Debug instructions", placeholder="Debug instructions", help="Instructions to help the AI debug the generated code.", label_visibility='collapsed',value=st.session_state.code_fix_instructions)
    ...
    with st.form('code_controls_form'):
        ...
        with file_name_col:
            code_file = st.text_input("File name", value="", placeholder="File name", help="Filename to use when downloading the code.", label_visibility='collapsed')
