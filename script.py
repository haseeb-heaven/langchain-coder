...
def main():
    ...
    with st.form('code_controls_form'):
        ...
        with convert_code_col:
            convert_submitted = st.form_submit_button("Convert", help="Convert code to the selected language")
            ai_llm_selected = None
        ...
        with run_code_col:
            execute_submitted = st.form_submit_button("Execute", help="Run the code and see output")
