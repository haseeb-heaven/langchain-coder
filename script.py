...
def main():
    ...
    with st.form('code_controls_form'):
        ...
        with save_code_col:
            download_code_submitted = st.form_submit_button("Download", help="Download the generated code as a file")
        ...
        with convert_code_col:
            convert_submitted = st.form_submit_button("Convert", help="Convert code to another programming language")
            ai_llm_selected = None
        ...
        with run_code_col:
            execute_submitted = st.form_submit_button("Execute", help="Run the generated code in the selected compiler")
        ...
        with example_code_col:
            example_submitted = st.form_submit_button("Example", help="Load a random code example for generation")
