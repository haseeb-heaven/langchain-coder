...
def main():
    ...
    with st.form('code_controls_form'):
        ...
        with save_code_col:
            download_code_submitted = st.form_submit_button("Download", help="Download the generated code to your machine")
        ...
        with debug_code_col:
            debug_submitted = st.form_submit_button("Debug", help="Fix errors in the generated code based on instructions")
        ...
        with convert_code_col:
            convert_submitted = st.form_submit_button("Convert", help="Convert the generated code to the selected language")
            ai_llm_selected = None
        ...
        with run_code_col:
            execute_submitted = st.form_submit_button("Execute", help="Run the generated code in the selected compiler mode")
        ...
        with example_code_col:
            example_submitted = st.form_submit_button("Example", help="Load a random example prompt and input/output")
