...
def main():
    ...
    with st.form('code_controls_form'):
        ...
        with generate_code_col:
            ...
            generate_submitted = st.form_submit_button(button_label, help="Generate or complete the code based on the prompt")
        ...
        with debug_code_col:
            debug_submitted = st.form_submit_button("Debug", help="Debug the generated code with the provided instructions")
