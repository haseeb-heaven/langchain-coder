...
def main():
    ...
    with st.form('code_controls_form'):
        ...
        with generate_code_col:
            ...
            generate_submitted = st.form_submit_button(button_label, help="Generate or complete code using the selected AI model")
        ...
        with debug_code_col:
            debug_submitted = st.form_submit_button("Debug", help="Debug the generated code based on provided instructions")
        ...
        with convert_code_col:
            convert_submitted = st.form_submit_button("Convert", help="Convert the generated code to the selected target language")
            ai_llm_selected = None
        ...
        with run_code_col:
            execute_submitted = st.form_submit_button("Execute", help="Execute the generated code in the chosen compiler mode")
