...
def main():
    ...
    with st.form('code_controls_form'):
        ...
        with generate_code_col:
            ...
            generate_submitted = st.form_submit_button(button_label, help="Generate or complete the code using the selected AI")
        ...
        with convert_code_col:
            convert_submitted = st.form_submit_button("Convert", help="Convert the code to the target programming language")
            ai_llm_selected = None
        ...
        with run_code_col:
            execute_submitted = st.form_submit_button("Execute", help="Run the generated code in the selected compiler environment")
        ...
        with example_code_col:
            example_submitted = st.form_submit_button("Example", help="Load a random coding task example")
