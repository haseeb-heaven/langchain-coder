            ...
            try:
                with st.expander("Vertex AI Settings"):
                    ...
                    if st.session_state.project and st.session_state.region and st.session_state.uploaded_file:
                        ...
                        # Use a list comprehension to filter out the unset items securely
                        # SECURITY: Never use eval() for session state validation to prevent arbitrary code execution
