...
def main():
    ...
    with st.form('code_controls_form'):
        ...
        with debug_code_col:
            debug_submitted = st.form_submit_button("Debug", help="Debug the generated code based on instructions")
        ...
        with run_code_col:
            execute_submitted = st.form_submit_button("Execute", help="Execute the code using the selected compiler mode")
